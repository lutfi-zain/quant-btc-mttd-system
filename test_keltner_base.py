#!/usr/bin/env python3
"""
Test Base Keltner Channel Signal with Common Filtering Framework
================================================================
...
print("=" * 70)
print("TEST BASE KELTNER CHANNEL SIGNAL — COMMON FILTERING FRAMEWORK")
print("=" * 70)
...
# ================================================================
# Layer 1: Keltner Channel Base Signal
# ================================================================
print("\n[3/6] Computing Keltner Channel base signal...")

# Keltner Channel parameters: 20 EMA, 1.5x ATR
KC_PERIOD = 20
KC_ATR_MULT = 1.5
...
# Base signal: Buy on upper breakout, Sell on lower breakdown
...
df['entry_signal'] = df['kc_buy'] * gates_pass

# Exit: Keltner sell (breakdown below lower band)
df['exit_signal'] = df['kc_sell']
...
# ================================================================
print("\n" + "=" * 70)
print("PERFORMANCE METRICS — KELTNER CHANNEL BASE")
print("=" * 70)

print(f"\n{'─'*50}")
print(f"  Signal:       Keltner Channel ({KC_PERIOD} EMA, {KC_ATR_MULT}x ATR breakout)")
...
print("\n" + "=" * 70)
print("TEST COMPLETE — KELTNER CHANNEL BASE")
print("=" * 70)
