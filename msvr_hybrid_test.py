#!/usr/bin/env python3
"""Test MSVR Hybrid with different min_hold values."""
...
def test_msvr_hybrid(df, config):
    """Test MSVR Hybrid with specific config."""
    ...
    exit_signal = (msvr_smooth < config.get('msvr_exit_threshold', -0.3)).astype(int)
...
if __name__ == "__main__":
    ...
    configs = [
        # MSVR Hybrid baseline (min_hold=10)
        {"name": "Hybrid base (mh=10)", "min_hold": 10, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        # MSVR Hybrid with min_hold=45
        {"name": "Hybrid mh=45", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        {"name": "Hybrid mh=45, exit=-0.2", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.2, "confirm_entry": 2},
        {"name": "Hybrid mh=45, exit=-0.4", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.4, "confirm_entry": 2},
        {"name": "Hybrid mh=45, exit=-0.5", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.5, "confirm_entry": 2},
        # Different entropy thresholds
        {"name": "Hybrid mh=45, ent=1.7", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 1.7, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.0", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.0, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.2", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.2, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.5", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.5, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        # Different ER thresholds
        {"name": "Hybrid mh=45, er=0.20", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.20, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        {"name": "Hybrid mh=45, er=0.35", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.35, "entropy_threshold": 1.9, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
        # Combined best guesses
        {"name": "Hybrid mh=45, ent=2.2, exit=-0.4", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.2, "msvr_exit_threshold": -0.4, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.5, exit=-0.4", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.5, "msvr_exit_threshold": -0.4, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.0, exit=-0.2", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.30, "entropy_threshold": 2.0, "msvr_exit_threshold": -0.2, "confirm_entry": 2},
        {"name": "Hybrid mh=45, ent=2.2, er=0.35, exit=-0.3", "min_hold": 45, "smooth_length": 7, "cycle_lookback": 40,
         "er_threshold": 0.35, "entropy_threshold": 2.2, "msvr_exit_threshold": -0.3, "confirm_entry": 2},
    ]
    ...
    print(f"{'Config':<50} {'Trades':>6} {'WinRate':>8} {'Sharpe':>7} {'CAGR':>7} {'TimeInMkt':>10}")
    print("-" * 95)

    for config in configs:
        name = config.pop('name')
        metrics = test_msvr_hybrid(df, config)
        print(f"{name:<50} {metrics['n_trades']:>6} {metrics['win_rate']:>7.1f}% {metrics['sharpe']:>7.2f} {metrics['cagr']:>6.1f}% {metrics['time_in_market']:>9.1f}%")
        config['name'] = name
